...
// Navigator = The JavaScript navigator object is used for browser detection, it can be used to get browser information such as appName, appCodeName, userAgent, etc. Navigator object is a window property so it can be accessed by the "window.navigator" or "navigator".
